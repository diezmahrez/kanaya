<!DOCTYPE html>
<!-- saved from url=(0035)edukasi.php -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Edukasi | Kanaya</title>
  <link rel="shortcut icon" href="assets/logo.png">
  
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
  <link href="./t_files/css" rel="stylesheet">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="./t_files/bootstrap.min.css">
  <link rel="stylesheet" href="./t_files/hover-min.css">
  <link rel="stylesheet" href="./t_files/font-awesome.min.css">
  <link rel="stylesheet" href="./t_files/style.css">
  <link rel="stylesheet" href="./t_files/animate.css">
  <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
  <script src="./t_files/jquery-1.12.0.min.js.download"></script>
</head>
<body style="background-color: #E5E5E5;">
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
              ...
              <ul class="nav navbar-nav headline-container">
                ...
                <p class="navbar-text ">Selamat datang, Mahrus Husaeni</p>
                <li>
                    </li><li>
                    </li>
                  </ul>
              ...
              <li class="dropdown">
                  <a href="edukasi.php#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id="search">
		...
		<div class="container konten-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body main">
					<div class="col-md-8">
											<div class="post" style="background-color: #04AA6D;border-radius: 10px; box-shadow: 1px 1px 20px -5px;padding: 2%;">
						
							
							<div class="row post-content">
								<div class="col-sm-12 excerpt" style="color: white;text-align: center;">
									<img src="./t_files/Pakaian-Adat-Ulos-Batak-1.jpg" class="wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
									
										<h2 style="color: white; font-weight: bold;">Kuis Umum 1</h2>
									</a>
									<p><i class="fa fa-question-circle" aria-hidden="true" style='font-size:36px'></i>  10 Pertanyaan <i class='fas fa-stopwatch' style='font-size:36px'></i>  15 S/Pertanyaan <i class="fas fa-check-circle" style='font-size:36px'></i>  1 Point / Soal </p>
									<a class="btn" href="Quiz/quiz1.html" style="border-radius: 10px;background-color: #00ffa1;color: black;font-weight: bold;">Mulai</a>
							</div>
							</div>
						</div>
						...
						<div class="row post-content">
							<div class="col-sm-12 excerpt" style="color: white;text-align: center;">
								<img src="./t_files/Pakaian-Adat-Ulos-Batak-1.jpg" class="wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
									...
									<h2 style="color: white; font-weight: bold;">Kuis Umum 2</h2>
								</a>
								<p><i class="fa fa-question-circle" aria-hidden="true" style='font-size:36px'></i>  10 Pertanyaan <i class='fas fa-stopwatch' style='font-size:36px'></i>  15 S/Pertanyaan <i class="fas fa-check-circle" style='font-size:36px'></i>  1 Point / Soal </p>
								<a class="btn" href="Quiz/quiz2.html" style="border-radius: 10px;background-color: #00ffa1;color: black;font-weight: bold;">Mulai</a>
						</div>
						</div>
					</div>		
											</div>
						...
						<div class="sidebar-item kategori">
							<h3 class="page-header">Kategori Quiz</h3>
							<ul class="nav nav-pills nav-stacked nav-kat">
							
															<li>
									<a href="quiz_umum.php" style="
...
<script src="./t_files/bootstrap.min.js.download"></script>
<script src="./t_files/jquery.ticker.min.js.download"></script>
<script src="./t_files/wow.min.js.download"></script>
<script src="./t_files/portalberita.js.download"></script>
