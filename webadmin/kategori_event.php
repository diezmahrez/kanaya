...
$sql = "SELECT id_kategori_ev, kategori FROM kategori_event LIMIT ".$offset.",". $limit;
$qry = $mysqli->query($sql) or die ($mysqli->error);

$sql_rec = "SELECT id_kategori_ev FROM kategori_event";
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-3">
								<form method="POST" action="aksi-kat_ev.php?act=tambah">
							...
							<table class="table table-hover">
								...
								<?php while ($kat_list = $qry->fetch_assoc()) { ?>
									<tr>
										<td align="right"><?php echo $kat_list['id_kategori_ev']; ?></td>
										<td><?php echo $kat_list['kategori'] ?></td>
										<td align="center">
											<?php if ($kat_list['kategori']!='Uncategorized') { ?>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="aksi-kat_ev.php?act=hapus2&amp;id=<?=$kat_list['id_kategori_ev']?>" class="btn btn-sm btn-danger">
												<i class="fa fa-trash"></i>
											</a>
											<a href="edit_ev.php?id=<?=$kat_list['id_kategori_ev']?>" class="btn btn-sm btn-success">
						...
						<div class="col-md-12">
							...
							<?php if ($noPage > 1) { ?>
								...
								<li>
									<a href="<?php echo "kategori_event.php?p=".($noPage-1);?>">
