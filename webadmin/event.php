...
ORDER BY event.tgl_posting DESC
LIMIT ".$offset.",". $limit;
		...
		<div class="col-lg-10 main-content">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-header"><i class="fa fa-newspaper-o"></i> Event</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<a href="tambah-event.php" class="btn btn-sm btn-primary">
								...
								<?php while ($news_list = $qry->fetch_assoc()) { ?>
									<tr>
										...
										<td align="center">
											...
											<a class="btn btn-sm btn-primary" target="_blank" href="<?php echo $base_url.'detail_ev.php?id='.$news_list['id_event']; ?>">
												<i class="fa fa-eye"></i>
											</a>
											<a href="edit-event.php?id=<?=$news_list['id_event']?>" class="btn btn-sm btn-success">
												<i class="fa fa-edit"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="hapus-event.php?id=<?=$news_list['id_event']?>" class="btn btn-sm btn-danger">
						...
						<div class="col-md-12">
							...
							<?php if ($noPage > 1) { ?>
								...
								<li>
									<a href="<?php echo "event.php?p=".($noPage-1);?>">
