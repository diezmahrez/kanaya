...
$var_teksevent = isset($_POST['teks_event']) ? $_POST['teks_event']:'';
$var_tanggal = isset($_POST['tanggal']) ? $_POST['tanggal']:'';
$var_lokasi = isset($_POST['lokasi']) ? $_POST['lokasi']:'';
$var_link = isset($_POST['link']) ? $_POST['link']:'';
if (isset($_POST['btn_publish'])) {
    ...
    if (count($message)==0) {
    	...
    	echo "<script>alert('Data Berhasil Ditambah'); window.location = 'event.php'</script>";
    }
...
?>
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-header"><i class="fa fa-newspaper-o"></i> Tambah event</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
