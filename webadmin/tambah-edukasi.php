...
$var_teksedukasi = isset($_POST['teks_edukasi']) ? $_POST['teks_edukasi']:'';
if (isset($_POST['btn_publish'])) {
    ...
    if (count($message)==0) {
    	$insert_sql = "INSERT INTO edukasi VALUES('',
    											 '$judul',
    											 '$kategori',
    											 '$file_name_gambar',
    											 '$teks_edukasi',
    	...
    	echo "<script>alert('Data Berhasil Ditambah'); window.location = 'edukasi.php'</script>";
    }
...
?>
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-header"><i class="fa fa-newspaper-o"></i> Tambah edukasi</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
