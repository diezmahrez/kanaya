...
kategori_event
WHERE
kategori_event.id_kategori_ev='$_GET[id]'";
...
if (isset($_POST['btn_edit'])) {
    ...
    if (count($message)==0) {
    	$insert_sql = "UPDATE kategori_event SET kategori = '$kategori' WHERE id_kategori_ev = '$_GET[id]'";
    	$insert_qry = $mysqli->query($insert_sql) or die ($mysqli->error);

    	echo "<script>alert('Data Berhasil Diperbarui'); window.location = 'kategori_event.php'</script>";
    }
					...
					<div class="row">
						<div class="col-md-12">
							<form action="" method="post" enctype="multipart/form-data">
								...
								<div class="col-sm-12">
									<a href="kategori_event.php" class="btn btn-danger btn-sm">
