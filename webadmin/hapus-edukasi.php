...
<?php
$sql_edukasi = "SELECT edukasi.gambar FROM edukasi WHERE edukasi.id_edukasi='$_GET[id]'";
...
if ($num==0) {
	...
	$del_sql = "DELETE FROM edukasi WHERE edukasi.id_edukasi='$_GET[id]'";

	$del_qry = $mysqli->query($del_sql);

	if ($del_qry) {
		unlink('../images/'.$data['gambar']);
		echo "<meta http-equiv='refresh' content='0;url=edukasi.php'>";
