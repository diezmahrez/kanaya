	<ul class="nav nav-side-menu">
		...
		<li><a href="edukasi.php"><i class="fa fa-folder-o"></i> Edukasi</a></li>
		<li><a href="kategori_edukasi.php"><i class="fa fa-folder-o"></i> Kategori Edukasi</a></li>
		<li><a href="berita.php"><i class="fa fa-newspaper-o"></i> Berita</a></li>
		<li><a href="kategori.php"><i class="fa fa-folder-o"></i> Kategori Berita</a></li>
		<li><a href="event.php"><i class="fa fa-folder-o"></i> Event</a></li>
		<li><a href="kategori_event.php"><i class="fa fa-folder-o"></i> Kategori Event</a></li>
