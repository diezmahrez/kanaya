...
if (isset($_POST['btn_simpan'])) {
    ...
    if (count($message)==0) {
    	...
    	$sql_update = "UPDATE admin SET email = '$txt_email',
					...
					<div class="row">
						<div class="col-md-12">
							<form action="" method="post" enctype="multipart/form-data">
								<div class="col-sm-4">
									<div class="form-group" style="box-shadow: 1px 1px 14px 0px;border-radius: 10px;padding: 5%;">
										<h4 style="font-weight: bold;text-align: center;">Foto Profil</h4>
										<div class="profile-pic">
											<img src="images/author/<?php echo $admin['foto']; ?> " style="width: -webkit-fill-available;">
										</div>
										<input type="file" name="foto">
										<label class="text-muted">Ukuran gambar maks. 2 MB dengan type: jpg, png, gif</label>
									</div>
								</div>
								<div class="col-sm-8" style="box-shadow: 1px 1px 14px 0px;border-radius: 10px;">
								<div class="headers">
									<h4 style="font-weight: bold;text-align: center;">Informasi Pengguna</h4>
								</div>
									<div class="form-group">
										<label>Email</label>
										<input type="text" style="border-radius: 10px;" class="form-control input-sm" name="txt_email" value="<?php echo $admin['email']; ?>">
									</div>
									<div class="form-group">
										<label>Username</label>
										<input type="text" style="border-radius: 10px;" class="form-control input-sm" name="txt_username" value="<?php echo $admin['username']; ?>">
									</div>
									<div class="form-group">
										<label>Nama Lengkap</label>
										<input type="text" style="border-radius: 10px;" class="form-control input-sm" name="txt_nmlengkap" value="<?php echo $admin['nama_lengkap']; ?>" maxlength="30">
									</div>
									<div class="form-group">
										<label>Bio</label>
										<textarea class="form-control input-sm" style="border-radius: 10px;" name="txt_deskripsi" rows="5"><?php echo $admin['deskripsi']; ?></textarea>
									</div>
									<hr>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="password" style="border-radius: 10px;" class="form-control input-sm" name="txt_passwordlama">
									</div>
									<div class="form-group">
										<label>Password Baru</label>
										<input type="password" style="border-radius: 10px;" class="form-control input-sm" name="txt_passwordbaru">
									</div>
									<div class="form-group">
										<label>Konfirmasi Password</label>
										<input type="password" style="border-radius: 10px;" class="form-control input-sm" name="txt_kpassword">
									</div>
								</div>
								<div class="col-sm-12">
